    ...
    <div className="container py-16">
        ...
        <div className="grid grid-cols-3 gap-3">
            <div className="relative rounded-sm overflow-hidden group">
                <img src="../../src/assets/images/category/category-1.jpg" alt="category 1" className="w-full"/>
                <a href="#"
            ...
            <div className="relative rounded-sm overflow-hidden group">
                <img src="../../src/assets/images/category/category-2.jpg" alt="category 1" className="w-full"/>
                <a href="#"
            ...
            <div className="relative rounded-sm overflow-hidden group">
                <img src="../../src/assets/images/category/category-3.jpg" alt="category 1" className="w-full"/>
                <a href="#"
            ...
            <div className="relative rounded-sm overflow-hidden group">
                <img src="../../src/assets/images/category/category-4.jpg" alt="category 1" className="w-full"/>
                <a href="#"
            ...
            <div className="relative rounded-sm overflow-hidden group">
                <img src="../../src/assets/images/category/category-5.jpg" alt="category 1" className="w-full"/>
                <a href="#"
            ...
            <div className="relative rounded-sm overflow-hidden group">
                <img src="../../src/assets/images/category/category-6.jpg" alt="category 1" className="w-full"/>
                <a href="#"
